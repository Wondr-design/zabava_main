...
export default function AdminLoginPage() {
  ...
  return (
    <AuthLayout
      ...
      description="Access the Zabava control centre to manage your platform."
      brandTitle="Control Centre"
      brandDescription="Manage partners, monitor analytics, and configure your entire platform from one powerful dashboard."
    >
