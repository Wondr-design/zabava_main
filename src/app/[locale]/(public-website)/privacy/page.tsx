...
export const metadata: Metadata = {
  title: "Privacy Policy | Zabava",
  description:
    "Learn how Zabava collects, processes, and protects visitor information submitted through our QR registration flows.",
};
...
export default async function PrivacyPolicyPage({
  ...
  const published = await getPublishedCmsPage("privacy", locale);
  const fallback = getDefaultCmsPage("privacy", locale);
  const title =
    published?.page.displayName ??
    fallback?.title ??
    "Privacy Policy";
  const blocks =
    published?.blocks ??
