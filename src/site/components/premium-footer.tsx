        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-white">Zabava</span>
            </div>
            <p className="text-gray-400 leading-relaxed max-w-sm">
              Transform your experience business with our all-in-one platform. 
              Connect with customers, streamline operations, and grow revenue.
            </p>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 rounded-lg bg-gray-800 hover:bg-yellow-500 hover:text-gray-900 flex items-center justify-center transition-colors"
                  >
        ...
        <div className="py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-sm text-gray-400">
            <div className="flex items-center gap-2">
              ...
              <a href="mailto:hello@zabava.com" className="hover:text-yellow-400 transition-colors">
                hello@zabava.com
              </a>
            </div>
            <div className="flex items-center gap-2">
